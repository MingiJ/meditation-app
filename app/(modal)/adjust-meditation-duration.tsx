  ...
  return (
    <View className='flex-1 relative'>
      <AppGradient colors={["#161b2e", "#0a4d4a", "#766e67"]}>
        <Text>Hello</Text>
        <Pressable className='absolute top-8 left-6 z-10' onPress={() => router.back()}>
          <AntDesign name='leftcircleo' size={50} color={"white"} />
        </Pressable>
        <View className='justify-center h-4/5 '>
          <Text className='text-center font-bold text-white mb-8 text-3xl'>Adjust your meditation duration</Text>
